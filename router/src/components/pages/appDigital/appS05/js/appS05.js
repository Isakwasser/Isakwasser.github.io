...
export default {
  ...
  methods: {
    hideElems() {
      ...
      this.$refs.appDigital__initialSignal_freq_afr_digit.style.display =
        "none";
      this.$refs.appDigital__initialSignal_freq_pfr_digit.style.display =
        "none";
    },
    initSignal() {
      /**
       * Вывод исходного графика на экран при необходимости
       */
      ...
      if (false) {
        ...
        showGraph(
          "appDigital__initialSignal_positive",
          imResp.time,
          imResp.signal
        );
      }
      ...
      showGraph(
        "appDigital__initialSignal_kroneker_zero",
        inputSignal_zero.time,
        inputSignal_zero.data
      );
      let outputSignal1 = {
        data: [],
        time: []
      ...
      showGraph(
        "appDigital__initialSignal_answer_zero",
        outputSignal1.time,
        outputSignal1.data
      );
      ...
      this.$refs.appDigital__initialSignal_kroneker_zero.style.display =
        "block";
